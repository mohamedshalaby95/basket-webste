...
// import { Card, CardContent, CardHeader } from "@/[locale]/components/ui/card";
...
const Blogs = async() => {
  const t = await getTranslations("Blogs"); // key prefix for your translation file
